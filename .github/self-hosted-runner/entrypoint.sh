...
export ACTIONS_RUNNER_HOOK_JOB_STARTED="${ACTIONS_RUNNER_HOOK_JOB_STARTED:-/usr/local/bin/runner-workdir-permissions.sh}"
export ACTIONS_RUNNER_HOOK_JOB_COMPLETED="${ACTIONS_RUNNER_HOOK_JOB_COMPLETED:-/usr/local/bin/runner-workdir-permissions.sh}"
